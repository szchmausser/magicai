...
@endif
<header class="site-header absolute inset-x-0  @if($fSectSettings->preheader_active) top-12 @else top-1 @endif z-50 text-white transition-[background,shadow] group/header [&.lqd-is-sticky]:bg-white [&.lqd-is-sticky]:shadow-[0_4px_20px_rgba(0,0,0,0.03)] [&.lqd-is-sticky]:text-black">
