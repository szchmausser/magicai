                    ...
                    @if(Auth::user()->type == 'admin')
						...
						<li class="nav-item">
							<a class="nav-link {{activeRoute('dashboard.admin.ads.index')}}" href="{{route('dashboard.admin.ads.index')}}">
								{{-- <span class="nav-link-icon inline-flex items-center border border-dark p-0 justify-center stroke-width='1.5' w-[15px] h-[15px] shrink-0 rounded-[6px] bg-[#ffffff] text-dark text-[13px] font-normal">
								...
								<svg xmlns="http://www.w3.org/2000/svg" class="m-1" height="18" viewBox="0 0 24 24" width="18">
									...
									<path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#8C9097"/><path d="M1 1h22v22H1z" fill="none"/></svg>
								<span class="flex items-center transition-[opacity,transform] nav-link-title grow">
									{{__('Google Adsense')}}
								</span>
							</a>
