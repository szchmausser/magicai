        ...
        <div class="items-center p-8 row max-lg:px-1">
            <div class="col">
                <a href="{{ route('index') }}" class="navbar-brand">
                    ...
                    <img src="/{{ $setting->logo_dashboard_path }}" @if (isset($setting->logo_dashboard_2x_path)) srcset="/{{ $setting->logo_dashboard_2x_path }} 2x" @endif
                    alt="{{ $setting->site_name }}" class="group-[.navbar-shrinked]/body:hidden dark:hidden">
                    <img src="/{{ $setting->logo_dashboard_dark_path }}" @if (isset($setting->logo_dashboard_dark_2x_path)) srcset="/{{ $setting->logo_dashboard_dark_2x_path }} 2x" @endif
                    alt="{{ $setting->site_name }}"
                    class="hidden group-[.navbar-shrinked]/body:hidden dark:block">
                    @else
                    <img src="/{{ $setting->logo_path }}" @if (isset($setting->logo_2x_path)) srcset="/{{ $setting->logo_2x_path }} 2x" @endif
                    alt="{{ $setting->site_name }}" class="group-[.navbar-shrinked]/body:hidden dark:hidden">
                    <img src="/{{ $setting->logo_dark_path }}" @if (isset($setting->logo_dark_2x_path)) srcset="/{{ $setting->logo_dark_2x_path }} 2x" @endif
                    alt="{{ $setting->site_name }}"
                    class="hidden group-[.navbar-shrinked]/body:hidden dark:block">
                    @endif
                </a>
                    ...
                    <div class="mx-auto col-lg-6">
                        ...
                        <div class="flex flex-wrap !gap-4 text-[13px] -tracking-[0.15px]]">
                            ...
                            <a href="{{ route('login.google') }}" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
                                <svg class="shrink-0 !me-2" width="22" height="22" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M12.714 22.5C15.6068 22.5 18.0353 21.5666 19.8092 19.9567L16.4282 17.3899C15.5235 18.0083 14.3092 18.4399 12.714 18.4399C9.88069 18.4399 7.47596 16.6083 6.61874 14.0766L6.49309 14.0871L3.18583 16.5954L3.14258 16.7132C4.90446 20.1433 8.5235 22.5 12.714 22.5Z" fill="#34A853" />
                            ...
                            <a href="{{ route('login.github') }}" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
                                <svg class="shrink-0 !me-2" width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <form novalidate="novalidate" onsubmit="return LoginForm();">
                            <div class="mb-[20px]">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="{{__('your@email.com')}}" value="{{ env('APP_STATUS') == 'Demo' ? 'admin@admin.com' : '' }}" autocomplete="off">
                            </div>
                            <div class="mb-[25px]">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" id="password" placeholder="{{__('Your password')}}" value="{{ env('APP_STATUS') == 'Demo' ? '12345678' : '' }}" autocomplete="off">
